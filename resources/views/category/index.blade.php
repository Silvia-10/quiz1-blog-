  ...
  <div class="modal-dialog">
   ...
   <div class="form-group">
    ...
    <input name="paket_category" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Paket Category">
     ...
     <p class="text-left">1. Cetak Extra Cepat</p>
      <p class="text-left">2. Cetak Biasa</p>
      <p class="text-left"> 3. Cetak Online</p>
             
        <p class="font-weight-bold">Paket Photo</p>
        <p class="text-left">Paket 1 -> Cetak 10 Photo + 5 Softcopy = Rp. 240.000</p>
        <p class="text-left">Paket 2 -> Cetak 5 Photo + 3 Softcopy = Rp. 100.000</p>
